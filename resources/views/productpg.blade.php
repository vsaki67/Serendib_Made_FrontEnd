...
@section('content')
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="mb-16 bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="md:flex">
                    <div class="md:w-1/2">
                        <div class="h-full">
                            <img src="{{ asset('Images_used/ProductPage_images/art4.png') }}" alt="Sacred Buddha Painting" class="featured-product-image w-full">
                        </div>
                    </div>
                    <div class="md:w-1/2 p-8 flex flex-col justify-center">
                        ...
                        <button 
                            class="add-to-cart-btn bg-[#007D7D] hover:bg-[#006666] text-white px-6 py-3 rounded-lg transition-colors font-semibold flex items-center justify-center gap-2"
                            data-id="art4"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="relative">
                        <div class="product-image-container">
                            <img src="{{ asset('Images_used/ProductPage_images/art1.png') }}" alt="Elephant Wood Carving" class="product-image">
                        </div>
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="relative">
                        <div class="product-image-container">
                            <img src="{{ asset('Images_used/ProductPage_images/art2.png') }}" alt="Traditional Mask" class="product-image">
                        </div>
                        <div class="absolute top-4 right-4">
                            <button class="p-2 bg-white rounded-full shadow-md hover:bg-[#FFCC00] transition-colors">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="relative">
                        <div class="product-image-container">
                            <img src="{{ asset('Images_used/ProductPage_images/art3.png') }}" alt="Temple Scene Canvas" class="product-image">
                        </div>
                        <div class="absolute top-4 right-4">
                            <button class="p-2 bg-white rounded-full shadow-md hover:bg-[#FFCC00] transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section id="batik" class="py-16 bg-white">
        <div class="container mx-auto px-4">
                ...
                <div class="md:flex items-center">
                    <div class="md:w-1/3 mb-6 md:mb-0 md:pr-8">
                        <div class="product-image-container rounded-lg overflow-hidden">
                            <img src="{{ asset('Images_used/ProductPage_images/batik1.png') }}" alt="Batik Artisan" class="product-image">
                        </div>
                    </div>
                    <div class="md:w-2/3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/batik2.png') }}" alt="Traditional Batik Dress" class="product-image">
                    </div>
                    <div class="p-6">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/batik3.png') }}" alt="Batik Mens Shirt" class="product-image">
                    </div>
                    <div class="p-6">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/batik4.png') }}" alt="Batik Scarf" class="product-image">
                    </div>
                    <div class="p-6">
    ...
    <section id="spices" class="py-16 bg-[#F8F5F0]">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/spice1.png') }}" alt="Ceylon Cinnamon" class="product-image">
                    </div>
                    <div class="p-6">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/spice2.png') }}" alt="Ceylon Cardamom" class="product-image">
                    </div>
                    <div class="p-6">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/spice3.png') }}" alt="Curry Spice Mix" class="product-image">
                    </div>
                    <div class="p-6">
    ...
    <section id="tea" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/tea1.png') }}" alt="Ceylon Earl Grey" class="product-image">
                    </div>
                    <div class="p-6">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/tea2.png') }}" alt="Orange Pekoe" class="product-image">
                    </div>
                    <div class="p-6">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/tea3.png') }}" alt="Ceylon Green Tea" class="product-image">
                    </div>
                    <div class="p-6">
    ...
    <section id="gems" class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/gem2.png') }}" alt="Blue Sapphire" class="product-image">
                    </div>
                    <div class="p-6">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/gem3.png') }}" alt="Star Ruby" class="product-image">
                    </div>
                    <div class="p-6">
                ...
                <div class="product-card bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="product-image-container">
                        <img src="{{ asset('Images_used/ProductPage_images/gem4.png') }}" alt="Yellow Sapphire" class="product-image">
                    </div>
                    <div class="p-6">
    ...
    <!-- Cart Link (should be in your layout file) -->
    <a href="/cart" class="flex items-center text-gray-700 hover:text-[#5E3023]">
